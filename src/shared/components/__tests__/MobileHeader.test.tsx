...
describe("MobileHeader", () => {
  ...
  it("should render both game mode buttons", () => {
    ...
    expect(screen.getByRole("button", { name: /infinity/i })).toBeInTheDocument();
    expect(screen.getByRole("button", { name: /core/i })).toBeInTheDocument();
  });

  it("should mark infinity as active when gameMode is infinity", () => {
    render(<MobileHeader {...defaultProps} gameMode="infinity" />);
  ...
  it("should mark core as active when gameMode is core", () => {
    render(<MobileHeader {...defaultProps} gameMode="core" />);
  ...
  it("should call onGameModeChange with infinity when clicking infinity button", () => {
  ...
  it("should call onGameModeChange with core when clicking core button", () => {
    const onGameModeChange = vi.fn();
    render(<MobileHeader {...defaultProps} onGameModeChange={onGameModeChange} />);
